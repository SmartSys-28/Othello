/*****************************************************************************
* Filename:          E:\Xilinx\EDKprojects\lab_vga/drivers/vga_ip_v1_00_a/src/vga_ip_selftest.c
* Version:           1.00.a
...
XStatus VGA_IP_SelfTest(void * baseaddr_p)
{
  ...
  VGA_IP_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = VGA_IP_mReadSlaveReg0(baseaddr, 0);
